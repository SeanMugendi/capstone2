// Read the locationsArray, parkTypesArray, and nationalParksArray from separate files
const locationsArray = [
  ...
  const parkTypesArray = [
    "National Park", "National Monument", "Recreation Area", "Scenic Trail", "Battlefield", "Historic", "Memorial", "Preserve", "Island", "River", "Seashore", "Trail", "Parkway"
  ];
...
// Function to populate dropdown options from an array
function populateDropdown(selectId, dataArray) {
  ...
  // Populate park type select dropdown
  ...
  function search(event) {
    ...
    const filteredParks = nationalParksArray.filter(park => park.State === selectedLocation && park.LocationName.includes(selectedParkType));
    ...
    filteredParks.forEach(park => {
      ...
      parkInfo.textContent = park.LocationName;
