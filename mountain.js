const mountainsArray = [
  ...
  selectOption.textContent = 'Select a Mountain';
  mountainSelect.appendChild(selectOption);
  ...
  function displayMountainDetails() {
    ...
    // Display the mountain details
    document.getElementById('mountainName').textContent = selectedMountain.name;
    document.getElementById('mountainImage').src = selectedMountain.img;
    document.getElementById('mountainElevation').textContent = `Elevation: ${selectedMountain.elevation} feet`;
    document.getElementById('mountainDescription').textContent = selectedMountain.desc;
    document.getElementById('mountainInfo').textContent = `Additional Information: ${selectedMountain.info}`;
  
    // Show the mountain details
    document.getElementById('mountainDetails').style.display = 'block';
  }
  
  // Add event listener to the search button
  const searchButton = document.getElementById('searchButton');
  searchButton.addEventListener('click', displayMountainDetails);
