...
const locationsArray = [
  ...
  // Perform search based on selected park type and location
  function search() {
    const parkType = document.getElementById("park-type").value;
    ...
    nationalParksArray.forEach(function(park) {
      if ((parkType === "" || parkType === parkTypesArray.includes(parkType)) &&
          (location === "" || location === park.State)) {
        const parkInfo = document.createElement("div");
        parkInfo.innerHTML = "<h3>" + park.LocationName + "</h3>" +
